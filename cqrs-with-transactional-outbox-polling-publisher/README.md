...
2. On a terminal, navigate to the "cqrs-with-transactional-outbox-polling-publisher" directory.
...
8. Run "cdk synth".
9. Run "cdk deploy". When the message "Do you wish to deploy these changes (y/n)?" shows up, type "y" and hit enter. This will create the entire infrastructure, and will take around 30 minutes.
